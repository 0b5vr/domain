import { add, assign, build, def, defInNamed, defOutNamed, defUniformNamed, discard, ifThen, insert, length, lt, main, max, mul, mulAssign, sin, sub, sw, texture, vec2, vec4 } from '../shader-builder/shaderBuilder';
