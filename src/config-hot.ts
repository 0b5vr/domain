export const
  ...
  // RTINSPECTOR_CAPTURE_NAME: string | null = 'Fluid/bufferDivergence',
  // RTINSPECTOR_CAPTURE_NAME: string | null = 'Fluid/swapVelocity0',
  // RTINSPECTOR_CAPTURE_NAME: string | null = 'Fluid/swapPressure0',
